...
- 2026-04-07 (follow-up): Added higher-signal reward feedback for the retention pass. Objective completion now triggers a larger celebration card, first sell gets a dedicated spotlight card with cents-aware messaging, hardware purchases show production deltas, and prestige token holders are treated as advanced saves so they do not repeat the onboarding building gates.
